---
name: speedy-lc
description: Understand code structure and change impact before editing. Use to get file/symbol skeletons cheaply (instead of reading whole files) and to find every caller a change would break, via the speedy-lc MCP. Trigger when planning a refactor, editing a widely-used symbol, or orienting in an unfamiliar codebase.
---

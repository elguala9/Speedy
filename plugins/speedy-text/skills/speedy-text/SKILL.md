---
name: speedy-text
description: Find every occurrence of a token and rename tokens project-wide across docs/config files (Markdown, JSON, YAML, .env, .toml, ...), via the speedy-text MCP. Trigger when locating a string/identifier or performing a multi-file rename instead of hand-editing files.
---
